...
def main():
    ...
    params = np.array([[55.11, 0.815],[99.94, 1.17],[22.09, 1.155],[70, 0.524]])
    ...
    for l in range(n_params):
        ...
        for n in range(200):
            ...
            obstacles = np.loadtxt("data/orig_traj/obstacles_"+str(l)+"_"+str(n)+".csv", delimiter=",")
            ...
            while(1):
                ...
                if distance_to_goal < threshold or frames > 5000:
                    if n%20 == 0:
                        print("Parameter number",l+1,", Trajectory number:",n+1)
                    np.savetxt("data/pred_traj/positions_param_"+str(l)+"_"+str(n)+".csv", position_array, delimiter=",",fmt ='% s')
