        ...
        for n in range(200):
            ...
            while(1):
                ...
                if distance_to_goal < threshold or frames > 5000:
                    ...
                    np.savetxt("data/orig_traj/positions_param_"+str(l)+"_"+str(n)+".csv", position_array, delimiter=",",fmt ='% s')
                    np.savetxt("data/orig_traj/obstacles_"+str(l)+"_"+str(n)+".csv", obstacles, delimiter=",",fmt ='% s')
                    break
